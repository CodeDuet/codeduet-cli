...
export class OpenAIContentGenerator implements ContentGenerator {
  ...
  constructor(
    ...
    // For local providers like Ollama and LM Studio, use a placeholder API key if none provided
    const apiKey = contentGeneratorConfig.apiKey || 
      (contentGeneratorConfig.authType === 'ollama' || contentGeneratorConfig.authType === 'lm-studio' 
