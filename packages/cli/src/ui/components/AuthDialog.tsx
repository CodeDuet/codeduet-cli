...
export function AuthDialog({
  ...
  const items = [
    { label: 'RunPod (Remote GPU)', value: AuthType.USE_RUNPOD },
    ...
    { label: 'xAI Grok', value: AuthType.USE_GROK },
    { label: 'Google Gemini', value: AuthType.USE_GEMINI },
  ...
  return (
    ...
    >
      ...
      <Box marginTop={1}>
        <Text>Terms of Services and Privacy Notice for CodeDuet</Text>
      </Box>
      <Box marginTop={1}>
